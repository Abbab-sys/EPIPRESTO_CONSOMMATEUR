...
/*
 * Name: ChatSection
 * Description: This file is used to display a chat section in the all chats page.
...
const ChatSection = (props: ChatSectionProps) => {
  return (
    <SafeAreaView style={ChatSectionStyles.root}>
      <TouchableOpacity
        style={ChatSectionStyles.container}
        onPress={props.goToChat}>
        <View style={ChatSectionStyles.view}>
          {props.imageSrc ? (
            <Image
              style={ChatSectionStyles.image}
              source={{uri: props.imageSrc}}
            />
          ) : (
            <Icon
              style={ChatSectionStyles.icon}
              name="user"
              size={30}
              color="black"></Icon>
          )}
          <View style={ChatSectionStyles.innerView}>
            <Text style={ChatSectionStyles.contactNameText}>
              {props.orderNum} - {props.relatedStoreName}
            </Text>
            <View style={ChatSectionStyles.bottomTextContainer}>
              <Text style={ChatSectionStyles.lastMessageText}>
                {props.lastMessage}
              </Text>
            </View>
          </View>
          {props.date !== null && (
            <Text style={ChatSectionStyles.date}>
