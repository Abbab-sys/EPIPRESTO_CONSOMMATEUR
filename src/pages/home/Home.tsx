...
/*
 * Name: Home
 * Description: This file is used to display the bottom navigation bar.
...
export const Home = () => {
  ...
  const onIndexChange = (index: number) => {
    setIndex(index);
    const dashboardStackIndex = routes.findIndex(
      route => route.key === STACK_KEY.DASHBOARD_STACK_KEY,
    );
  ...
  // Render the scene of the bottom navigation bar
