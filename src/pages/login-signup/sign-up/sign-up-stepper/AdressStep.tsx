...
/*
 * Name: Adress Step
 * Description: This file is used to display the third step of the signup process (address).
...
const AdressStep = (props: AdressStepProps, ref: Ref<AdressStepRef>) => {
  ...
  // Imperative handle to get the address
  useImperativeHandle(
    ref,
    () => ({
  ...
  // Function to check if the inputs are valid and set the step as completed
  useEffect(() => {
    const stepCompleted =
      !!streetNumber &&
