...
/*
 * Name: Orders Item
 * Description: This file is used to display the order item in the orders history page.
 * Author: Adam Naoui-Busson, Zouhair Derouich, Alessandro van Reusel
 */
      ...
      <View style={orderStyles.orderView}>
        ...
        <View style={orderStyles.descriptionView}>
          ...
          <Text style={orderStyles.restOfDescriptionText}>
            ...
            {order.numberOfProducts > 1 ? 's' : ''} |{' '}
            {(Math.round(order.price * 100) / 100).toFixed(2)} $
          </Text>
          <Text style={orderStyles.restOfDescriptionText}>
