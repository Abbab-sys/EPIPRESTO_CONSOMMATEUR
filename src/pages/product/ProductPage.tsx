            ...
            <SafeAreaView>
                {
                    loading ? (
                        ...
                        <View style={productPageStyles.innerContainer}>
                            <Text style={productPageStyles.errorText}>{t('store.data.error')}</Text>
                        </View>)
                        : (
                            variants.length === 0 ?
                                ...
                                (
                                    <FlatList
                                        ...
                                        onEndReached={() => {
                                            if (data.getProductById.product.variants.length > variants.length) {
                                                fetchMore({
                                                    variables: {
                                                    ...
                                                    updateQuery: (prev, { fetchMoreResult }) => {
                                                        ...
                                                        const remainingVariants = fetchMoreResult.getProductById.product.variants
                                                        const publishedVariants = remainingVariants.filter((variant: any) => {
                                                            return variant.availableForSale
                                                        })
